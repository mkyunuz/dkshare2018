...
class DistributorSearch extends Distributor
{
    ...
    public function rules()
    {
        return [
            [['id', 'status'], 'integer'],
            [['distributor_name', 'titik_id','username', 'distributor_id', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'distributor_name', $this->distributor_name])
            ...
            ->andFilterWhere(['like', 'titik.titik_name', $this->titik_id])
